...
/* harmony import */ var _modules_Controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/Controller */ "./src/pages/Background/modules/Controller.js");
...
chrome.runtime.onInstalled.addListener(() => {
  console.log("[BackgroundScript] Installing... " + (0,_utils_time_utils__WEBPACK_IMPORTED_MODULE_2__.get_local_datetime)(new Date())); // Initialize local storage || WARNING --> THIS RESETS ALL chrome.storage KEYS TO DEFAULT VALUES

  chrome.storage.local.set(_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_DEFAULT);
}); // Message listeners //
...
controller.init(); // Signal handlers

const receive_emergency_save_data_signal = async (message, sender, sendResponse) => {
  if (message[_config__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_TEMPLATE.HEADER] === "SAVE_DATA") {
    ...
    sendResponse({
      msg: "Signal received. Content script injected"
    }); // Essential sendResponse
  }
};

const receive_finished_signal = async (message, sender, sendResponse) => {
  if (message[_config__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_TEMPLATE.HEADER] === _config__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_HEADERS.FINISHED) {
...
(function () {
  ...
  reactHotLoader.register(controller, "controller", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\pages\\Background\\index.js");
  reactHotLoader.register(receive_emergency_save_data_signal, "receive_emergency_save_data_signal", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\pages\\Background\\index.js");
  reactHotLoader.register(receive_finished_signal, "receive_finished_signal", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\pages\\Background\\index.js");
})();
...
/***/ "./src/pages/Background/modules/Controller.js":
/*!****************************************************!*\
  !*** ./src/pages/Background/modules/Controller.js ***!
  \****************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_time_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../utils/time_utils */ "./src/utils/time_utils.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../config */ "./src/pages/config.js");
/* module decorator */ module = __webpack_require__.hmd(module);
(function () {
  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;
  enterModule && enterModule(module);
...
class Controller {
  ...
  async init() {
    console.log("[Controller] Initializing..." + (0,_utils_time_utils__WEBPACK_IMPORTED_MODULE_0__.get_local_datetime)(new Date()));
  ...
  async injectScript(tabId) {
    const running = (await chrome.storage.local.get([_config__WEBPACK_IMPORTED_MODULE_1__.STORAGE_KEYS.RUNNING]))[_config__WEBPACK_IMPORTED_MODULE_1__.STORAGE_KEYS.RUNNING];
    ...
    const count = (await chrome.storage.local.get([_config__WEBPACK_IMPORTED_MODULE_1__.STORAGE_KEYS.VIDEO_COUNT]))[_config__WEBPACK_IMPORTED_MODULE_1__.STORAGE_KEYS.VIDEO_COUNT];
    await chrome.storage.local.set({
      [_config__WEBPACK_IMPORTED_MODULE_1__.STORAGE_KEYS.VIDEO_COUNT]: count + 1
    });
    await chrome.scripting.executeScript({
      target: {
        tabId: tabId
...
(function () {
  ...
  reactHotLoader.register(Controller, "Controller", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\pages\\Background\\modules\\Controller.js");
})();
