...
/***/ "./src/pages/Content/test_content_script.js":
/*!**************************************************!*\
  !*** ./src/pages/Content/test_content_script.js ***!
  \**************************************************/
...
/* harmony import */ var _utils_save_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/save_json */ "./src/utils/save_json.js");
...
const init = async () => {
  ...
  const res = await chrome.storage.local.get([_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.DATA_TO_SAVE, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.ARCHIVE_TO_SAVE, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.ASSESSMENTS_TO_SAVE, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.DEVICE_ID, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.EXPERIMENT_TYPE, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_LIMIT, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_URLS, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.TESTER_ID, _config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_COUNT]);
  const data = res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.DATA_TO_SAVE];
  const archive = res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.ARCHIVE_TO_SAVE];
  const assessments = res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.ASSESSMENTS_TO_SAVE];
  console.log(data);
  console.log(archive);
  console.log(assessments);
  const episode_limit = parseInt(res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_LIMIT]);
  const video_count = parseInt(res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_COUNT]);
  const episode_index = video_count - 1; // Complete data

  const results = {
    info: {
      device_id: res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.DEVICE_ID],
      experiment_type: res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.EXPERIMENT_TYPE],
      video_limit: res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_LIMIT],
      video_index: episode_index,
      video_url: res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.VIDEO_URLS][episode_index],
      tester_id: res[_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_KEYS.TESTER_ID]
    },
  ...
  const results_json = (0,_utils_save_json__WEBPACK_IMPORTED_MODULE_2__.save_json)(results, results_filename);
  setTimeout(() => {
    const archive_json = (0,_utils_save_json__WEBPACK_IMPORTED_MODULE_2__.save_json)(archive, archive_filename);
  }, 2000);
};
...
(function () {
  ...
  reactHotLoader.register(init, "init", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\pages\\Content\\test_content_script.js");
})();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "save_json": () => (/* binding */ save_json)
/* harmony export */ });
/* module decorator */ module = __webpack_require__.hmd(module);
(function () {
  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;
...
const save_json = function (obj, filename) {
  try {
...
(function () {
  ...
  reactHotLoader.register(save_json, "save_json", "C:\\Users\\rafal\\Desktop\\TUFIQoE\\WatchingWithFriends-TUFIQoE-2022\\extension\\src\\utils\\save_json.js");
})();
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("testScript." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/pages/Content/test_content_script.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=testScript.bundle.js.map