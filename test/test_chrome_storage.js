import { ARCHIVE_DEFAULT, DATABASE_DEFAULT } from "../src/pages/config"

export const test_chrome_storage = async () => {
    console.log("Hello world")
    const database = DATABASE_DEFAULT
    const archive = ARCHIVE_DEFAULT
    ...
    const limit = 5242880
    console.log(roughSizeOfObject(database))
    console.log(roughSizeOfObject(archive))
    ...
    try{
        ...
        console.log("Saving database failed")
        console.log(err)
    }
    ...
    try{
        ...
        console.log("Saving archive failed")
        console.log(err)
    }
}
